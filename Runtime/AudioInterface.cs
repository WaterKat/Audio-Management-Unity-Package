...
{
    [CreateAssetMenu(fileName = "New Audio Interface", menuName = "WaterKat/Audio Interface", order = -951)]
    public class AudioInterface : ScriptableObject
    {
        ...
        {
            //AudioManager.ValidateAudioInterface(this);
        }

        private void OnEnable()
        {
            AudioManager.RegisterAudioInterface(this);
        }

        private void OnDisable()
        {
            AudioManager.UnRegisterAudioInterface(this);
        }
